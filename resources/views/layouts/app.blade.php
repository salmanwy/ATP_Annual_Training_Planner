...
<body>
    ...
    <section id="footer">
        <div class="container">
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12 mt-2 mt-sm-0">
                    <ul class="list-unstyled list-inline social text-center">
                        <li class="list-inline-item"><a style="color: blue !important;" href="https://www.facebook.com/1manSalman"><i class="fa fa-facebook"></i></a></li>
                        <li class="list-inline-item"><a style="color: blue !important;"href="https://www.twitter.com/1manSalman"><i class="fa fa-twitter"></i></a></li>
                        <li class="list-inline-item"><a
                        style="color: blue !important;" href="https://instagram.com/1manSalman"><i class="fa fa-instagram"></i></a></li>
                    </ul>
                </div>
                <hr>
            </div>  
